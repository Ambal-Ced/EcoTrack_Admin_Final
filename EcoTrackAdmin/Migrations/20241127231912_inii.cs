...
namespace EcoTrackAdmin.Migrations
{
    /// <inheritdoc />
    public partial class inii : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmailRequests", x => x.requestid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeedbackDatas", x => x.cid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProfiles", x => x.UniqueUserName);
                    table.ForeignKey(
